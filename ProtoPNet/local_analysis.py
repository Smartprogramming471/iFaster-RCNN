...
-modeldir is the directory containing the model you want to analyze : './saved_models/vgg19/003/'
-model is the filename of the saved model you want to analyze : './saved_models/vgg19/003/28nopush0.7522.pth'
-imgdir is the directory containing the image you want to analyze : './local_analysis/Painted_Bunting_Class15_0081/'
-img is the filename of the image you want to analyze : 'Painted_Bunting_0081_15230.jpg'
-imgclass is the (0-based) index of the correct class of the image : 15

#helper
python3 local_analysis.py -modeldir './saved_models_100/vgg19/003/' -model '82push0.9953.pth' -imgdir './local_analysis/3050_0923627159_01_WRI-R2_M015_0_rec/' -img '3050_0923627159_01_WRI-R2_M015_0.png' -imgclass 1
python3 local_analysis.py -modeldir './saved_models_100/vgg19/003/' -model '82push0.9953.pth' -imgdir './local_analysis/3841_1074609671_04_WRI-L2_M013_0/' -img '3841_1074609671_04_WRI-L2_M013_0.png' -imgclass 0
python3 local_analysis.py -modeldir './saved_models_100/vgg19/003/' -model '82push0.9953.pth' -imgdir './local_analysis/2241_1074115078_02_WRI-R2_M012_0/' -img '2241_1074115078_02_WRI-R2_M012_0.png' -imgclass 0
python3 local_analysis.py -modeldir './saved_models_100/vgg19/003/' -model '82push0.9953.pth' -imgdir './local_analysis/4903_0814003975_05_WRI-L2_M015_0/' -img '4903_0814003975_05_WRI-L2_M015_0.png' -imgclass 2
srun python3 local_analysis.py -modeldir './saved_models_85_224_19/vgg19/003/' -model '82_16push0.9409.pth' -imgdir './local_analysis/2241_1074115078_02_WRI-R2_M012_0_1/' -img '2241_1074115078_02_WRI-R2_M012_0.png' -imgclass 0
srun python3 local_analysis.py -modeldir './saved_models_85_224_19/vgg19/003/' -model '82_16push0.9409.pth' -imgdir './local_analysis/4903_0814003975_05_WRI-L2_M015_0_1/' -img '4903_0814003975_05_WRI-L2_M015_0.png' -imgclass 2
...
# Define a new function for resizing with aspect ratio preservation
...
if check_test_accu:
    ...
    test_dataset = datasets.ImageFolder(
        test_dir,
        resize_with_aspect_ratio(img_size))
        # transforms.Compose([
...
preprocess = resize_with_aspect_ratio(img_size)
# transforms.Compose([
